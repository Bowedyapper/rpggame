...
# SDL2TTFFOUND (same value as SDL2_TTF_FOUND)
#
#
#
...
if(NOT SDL2_TTF_INCLUDE_DIR AND SDL2TTFINCLUDE_DIR)
...
if(NOT SDL2_ITTF_LIBRARY AND SDL2TTF_LIBRARY)
...
if(SDL2_TTF_INCLUDE_DIR AND EXISTS "${SDL2_TTF_INCLUDE_DIR}/SDL2_ttf.h")
  ...
  string(REGEX REPLACE "^#define[ \t]+SDL2_TTF_MINOR_VERSION[ \t]+([0-9]+)$" "\\1" SDL2_TTF_VERSION_MINOR "${SDL2_ITTFVERSION_MINOR_LINE}")
  string(REGEX REPLACE "^#define[ \t]+SDL2_TTF_PATCHLEVEL[ \t]+([0-9]+)$" "\\1" SDL2_TTF_VERSION_PATCH "${SDL2_ITTFVERSION_PATCH_LINE}")
